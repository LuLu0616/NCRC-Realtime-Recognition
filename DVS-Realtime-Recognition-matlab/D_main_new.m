...
poolsize1 = 2;
poolsize2 = 2;
imsize0 = [34 34];  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%需要改1（nminist34*34 gesture128*128）
...
%%
data_directory = 'D:\Projects\matlab\DVS-Realtime-Recognition-matlab\MNIST_DVS_full';%%%%%%%%%%%%%%%%需要改3（数据集）
working_directory = 'D:\Projects\matlab\DVS-Realtime-Recognition-matlab\MNIST_DVS_full_RESULTS';%%%%%%%%%%%%%%%%%%%%需要改4（生成的结果）
